...
{
    [Command("lmbtfy", "Lmbtfy_CommandInfo", "[@user] query", "user")]
    public class LmbtfyCommand : UserCommand
    {
        public override void Execute(CommandContext context, CallerContext callerContext, Models.ChatUser callingUser, string[] args)
        {
            ...
            string tinyUrlRequest = string.Format("http://tinyurl.com/api-create.php?url=http://letmebingthatforyou.com/?q={0}", Uri.EscapeDataString(query));
