...
namespace JabbR {
    ...
    public class LanguageResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to There is a time difference or significant network latency between the server and client ({dif} seconds). Unusual behaviour can be expected until the problem is corrected..
        /// </summary>
