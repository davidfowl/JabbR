...
namespace JabbR {
    ...
    public class LanguageResources {
        ...
        public static string Giphy_CommandInfo {
            get {
                return ResourceManager.GetString("Giphy_CommandInfo", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Limit the randomness by keywords. Excluding keywords will return a random GIF from the Giphy catalog..
        /// </summary>
        public static string Giphy_DataRequired {
            get {
                return ResourceManager.GetString("Giphy_DataRequired", resourceCulture);
            }
        }
