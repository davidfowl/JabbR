    ...
    public class CommandManagerFacts
    {
        ...
        public class MemeCommand
        {
            ...
            public void CanGenerateMeme()
            {
                ...
                // Assert.
                Assert.True(result);
                notificationService.Verify(x => x.SendMessage(room, "https://upboat.me/aa/top-line/bottom-line.jpg"), Times.Once());
            }
            ...
            public void EncodesSpecialCharacters()
            {
                ...
                // Assert.
                Assert.True(result);
                notificationService.Verify(x => x.SendMessage(room, "https://upboat.me/ramsay/cold-hands%3F/type-faster...%2F..jpg"), Times.Once());
            }
